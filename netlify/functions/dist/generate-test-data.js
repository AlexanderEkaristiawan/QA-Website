...
const handler = async (event) => {
    ...
    try {
        ...
        const { category = 'users', customPrompt = '', count = 5, format = 'json', locale = 'International / Indonesian', } = body;
        let promptContext = '';
        if (category === 'users') {
...
${format === 'json'
        ...
        let usageInfo = null;
        try {
            const geminiRes = await (0, gemini_1.callGeminiWithUsage)(prompt, 3000, 0.4);
